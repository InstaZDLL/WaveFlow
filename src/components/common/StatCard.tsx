...
export function StatCard({
  ...
  const classes =
    "p-4 rounded-2xl border flex items-center space-x-4 shadow-sm transition-all bg-white border-zinc-100 dark:bg-zinc-800/40 dark:border-zinc-700/50 cursor-pointer text-left w-full hover:shadow-md hover:border-emerald-200 dark:hover:border-emerald-500/40 dark:hover:bg-zinc-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 active:scale-[0.98]";
