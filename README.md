...
| **Plugins**         | RFC-002 **plugin SDK** — wasmtime sandbox with permission gates, manifest-declared host APIs + per-plugin settings; in-app **plugin store** with a curated catalogue and blake3-verified installs; two official plugins — **Web Radio** (30 000+ radio-browser.info stations through the cpal engine, live ICY "now playing", per-profile favorites + country browsing, offline catalogue snapshot) and **Apple Motion Artwork** (animated album covers behind the now-playing view)                                                                                                                            | [docs](docs/features/plugins.md) · [RFC-002](docs/rfcs/RFC-002-plugin-sdk.md) |
