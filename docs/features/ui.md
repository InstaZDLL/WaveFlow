...
- **Unlocked** — hovering shows a frame, a lock button and a close button, and raises the background to at least 35 % so the window's extent is visible; dragging anywhere moves it.
